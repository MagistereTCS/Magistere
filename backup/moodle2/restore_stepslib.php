...
class restore_block_instance_structure_step extends restore_structure_step {
    ...
    public function process_block($data) {
        ...
        $params = array(
            ...
            'subpagepattern' => $data->subpagepattern, 'defaultregion' => $data->defaultregion, 'sectionid' => $data->sectionid);
        ...
        // Set task old contextid, blockid, sectionid and blockname once we know them
        $this->task->set_old_contextid($oldcontextid);
        $this->task->set_old_blockid($oldid);
        $this->task->set_old_blocksectionid($oldsectionid);
    ...
    protected function after_restore() {
    	...
    	$sectionid = $this->task->get_old_blocksectionid();
    	
    	if ($sectionid != null && $sectionid > 0)
    	{
	    	$new_sectionid = $this->get_mappingid('course_section', $sectionid);
	    	$DB->set_field('block_instances', 'sectionid', $new_sectionid, array('id' => $blockid));
    	}
    }
}
