...
abstract class restore_block_task extends restore_task {
    ...
    protected $oldblocksectionid; // old (original) id of the block section
    ...
    public function set_old_blocksectionid($blocksectionid) {
    	$this->oldblocksectionid= $blocksectionid;
    }
    
    public function get_old_blocksectionid() {
    	return $this->oldblocksectionid;
    }
