...
class core_tag_area {
    ...
    protected static function delete($record) {
		...
		get_centralized_db_connection()->delete_records('tag_area',
    ...
    protected static function create($record) {
        ...
        get_centralized_db_connection()->insert_record('tag_area', array('component' => $record->component,
    ...
    public static function update($existing, $data) {
        ...
        $data['id'] = $existing->id;
        get_centralized_db_connection()->update_record('tag_area', $data);
    ...
    public static function uninstall($pluginname) {
        ...
        get_centralized_db_connection()->delete_records('tag_area', array('component' => $component));
        get_centralized_db_connection()->delete_records('tag_coll', array('component' => $component));
    ...
    public static function move_tags($component, $itemtype, $tagcollid) {
        ...
        foreach ($result as $tag) {
            ...
            $tag->id = get_centralized_db_connection()->insert_record('tag', $tag);
