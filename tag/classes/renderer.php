...
//        $rv .= $this->output->heading($tagname, 2);
        ...
        $rv .= $this->encart_block_tag($tagname);
        $rv .= '<h3 style ="font-size: 15px;margin-left: 10px;font-family: \'open sans\',sans-serif;font-weight: bold;">'.get_string('tcsitemstaggedwith', 'tag').'</h3>';
...
*/
    ...
    function encart_block_tag($tagname)
    {
        global $OUTPUT;
        ...
        $tagarea = html_writer::span(' '.$tagname, 'badgename');
        $html .= html_writer::div($tagarea);
