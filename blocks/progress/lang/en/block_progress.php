...
$string['centralizedresources'] = 'Centralized resource';
$string['chat'] = 'Chat';
$string['choice'] = 'Choice';
$string['choicegroup'] = 'Choice Group';
...
$string['socialforum'] = 'Social Forum';
$string['scorm'] = 'SCORM';
$string['scormcentralized'] = 'centralized scorm';
$string['url'] = 'URL';
$string['wiki'] = 'Wiki';
$string['workshop'] = 'Workshop';
$string['nanogong'] = 'nanoGong';
$string['via'] = 'Via';
$string['viaassign'] = 'Via Delegated';

$string['select_an_activity'] = 'Select an activity';
$string['activity_status'] = 'Activity status';
$string['realized'] = 'realized';
$string['notrealized'] = 'Not realized';
$string['select_an_action'] = 'Select an action';
$string['formation_finished'] = 'Formation finished';
$string['send_message'] = 'Send a message';
$string['mass_action'] = 'Mass action';
$string['refresh_cache'] = 'Refresh';
$string['filter'] = 'Filter';

$string['connected'] = 'Connection';
$string['neverconnected'] = 'Users who have never connected to the course';


// jtable header
$string['jttitle'] = 'Users';
...
$string['submitted_group'] = 'submitted in group';
$string['marked_group'] = 'marked in group';
$string['passed_group'] = 'passed in group';

$string['comment'] = 'comment';
$string['add_page_group'] = 'contributed in group';
$string['comment_group'] = 'comment in group';
$string['viewed_group'] = 'viewed in group';
...
$string['warning_user_notimeaccess'] = 'The training can not be certified as complete for those who have not logged in to this training session.
They will be indicated absent in the attestation of attendance';
$string['certificate_participation'] = 'Certificate of participation';
$string['certificate_participation_help'] = 'To certify participation you must indicate that the training is completed for the users concerned.
<a href="https://wiki.magistere.education.fr/Attester_la_pr%C3%A9sence_des_participants_%C3%A0_la_fin_d%27une_formation" target="_blank"><b>Learn more</b></a>';
...
$string['cache_update'] = 'Update now';
$string['cache_last_update'] = 'Last update';
...
$string['progress:delinstance'] = 'Delete the Progress Bar block';

$string['gaia_session'] = 'Gaïa session';
$string['other_participants'] = 'Others participants';
