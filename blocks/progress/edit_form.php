        ...
        foreach ($modules as $module => $details) {
            ...
            if (!empty($instances)) {
                ...
                foreach ($instances as $i => $instance) {
                    ...
                    // Progress block activity position (ajout MRO)
                    $mform->addElement('text', 'config_position_'.$module.$instance->id,
                                       'Position');
                    $mform->setDefault('config_position_'.$module.$instance->id, '');
                    $mform->disabledif ('config_position_'.$module.$instance->id,
                                        'config_monitor_'.$module.$instance->id, 'eq', 0);
