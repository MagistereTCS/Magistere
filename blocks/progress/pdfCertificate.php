...
$cmd = $CFG->wkhtmltopdf_path.' --image-dpi 600 --footer-right "Page [page] sur [toPage]" "'.$CFG->wwwroot.'/blocks/progress/pdfCertificateSources.php?courseid='.$courseid.'&data='.$data.'" '.$tmp_pdf;
