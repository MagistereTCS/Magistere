...
class block_edit_form extends moodleform {
    ...
    function definition() {
        ...
        // ==============================================================
        // =====3385: [Marque blanche] Le format thématique magistere et moduleur ARO==========
        // ==============================================================
        ...
        if ($courseid !== null)
        {
        	...
        	{
        	    $coursedisplay = $DB->get_record('course_format_options', array('courseid'=>$courseid,'format'=>'topics','name'=>'coursedisplay'));
        	    
        	    if ($coursedisplay->value == 1)
        	    {
        	        
        	        $mform->addElement('header', 'onthissection', get_string('onthissection', 'block'));
        	        ...
        	        $mform->addElement('select', 'bui_sectionid', get_string('sectionid', 'block'), $sectionoptions);
        	    }
        	}
        }
        // -------------
        ...
        //TCS BEGIN 2020/03/17 - ARO 3780
        global $USER,$CFG;
        if (!$this->page->user_can_edit_blocks() || (isset($this->block->blockname) && $this->block->blockname == "block_settings" && !in_array($USER->id,$CFG->user_allowed_edit_settingsblock_params) )) {
            $mform->hardFreeze($pagefields);
        }
        //TCS END 2020/03/17 - ARO
    ...
    function set_data($defaults) {
        ...
        $blockfields = array('showinsubcontexts', 'pagetypepattern', 'subpagepattern', 'parentcontextid',
                'defaultregion', 'defaultweight', 'visible', 'region', 'weight', 'sectionid');
