...
class block_configurable_reports extends block_list {
    ...
    public function get_content() {
        ...
        //TCS#3915 begin
        if(file_exists($GLOBALS['CFG']->dirroot.'/local/custom_reports/lib.php')){
            $this->content->items[] = '<a href= "'.$CFG->wwwroot.'/local/custom_reports/custom_reports.php">'.get_string('query_stats_2020', 'block_configurable_reports').'</a>';
            $this->content->items[] = '========';
        }
        //TCS#3915 end
