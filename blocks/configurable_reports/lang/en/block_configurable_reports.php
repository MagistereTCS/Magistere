...
$string['magsubcategories'] = 'Category (Include sub categories)';
$string['filtermagsubcategories'] = 'Category (Include sub categories)';
$string['filtermagsubcategories_summary'] = 'Use: %%FILTER_MAG_SUBCATEGORIES:mdl_course_category.id:mdl_course_category.path%%';
