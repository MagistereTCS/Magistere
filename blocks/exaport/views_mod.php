...
$iv = -1;
if ($type == 'title') $iv = 0;
elseif ($type == 'layout') $iv = 1;
elseif ($type == 'content') $iv = 2;
elseif ($type == 'share') $iv = 3;
...
<script>
	$(document).ready(function() {
		var index = <?php echo $iv ?>;
		if (index != -1) {
			$("#region-main .tabtree ul li.selected ul li").eq(index).addClass('active');
		}
	});
</script>