    ...
    function get_content() {
        ...
        if (!empty($entries)) {
            ...
            foreach ($entries as $entryid => $entry) {
                ...
                //TCS_QGO set new params for summary
                $viewblogurl->param('courseid', $context->instanceid);
                if($currentsectionid!=0){
                    $viewblogurl->param('section', $currentsectionid);
                }
            ...
            if($currentsectionid!=0){
                $url->param('section', $currentsectionid);
            }
