 ...
 * @license   http://www.gnu.org/copyleft/gpl.educationalbloc GNU GPL v3 or later
 */

/**
 * Specialised restore task for the educationalbloc block
 * (requires encode_content_links in some configdata attrs)
 *
 * TODO: Finish phpdocs
 */
class restore_educationalbloc_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_educationalbloc_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_educationalbloc_block_decode_content extends restore_decode_content {
    ...
    protected function get_iterator() {
        ...
        $sql = "SELECT t.id, $fieldslist
                 ...
                 WHERE b.backupid = ?
                   AND b.itemname = ?
                   AND t.blockname = 'educationalbloc'";
