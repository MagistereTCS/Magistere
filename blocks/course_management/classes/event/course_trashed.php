 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_trashed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcoursetrashed','block_course_management');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' trashed the course with id '$this->courseid'.";
    }
