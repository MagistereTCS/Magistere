...
namespace block_course_management\event;

defined('MOODLE_INTERNAL') || die();

/**
 * Course trashed event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_untrashed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcourseuntrashed','block_course_management');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' untrashed the course with id '$this->courseid'.";
    }
