...
if ($usercandownload and $download != -1 and !empty($downloadcourseid)) {
    ...
    // Suppression de la taille du fichier lors du restore.
    ...
    echo $OUTPUT->notification(get_string('downloadconfirmed', 'block_community',
        '/downloaded_backup/' . $privatefilename), 'notifysuccess');
    ...
    $indexationServices->setRestoreHubCourseID($downloadcourseid);
    // END VSE
