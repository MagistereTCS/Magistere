...
class MoodleQuickForm_editor extends HTML_QuickForm_element implements templatable {
    ...
    function toHtml() {
        ...
        if ($maxfiles != 0 ) {
            ...
            $args->context = $ctx;
            $args->env = 'filepicker';
            $args->type = 'nocentralizedresources'; // TCS 2019 JBL
            // advimage plugin
            ...
            // TCS 2019 JBL : ajout moodlecentralizedmedia plugin
            $args->accepted_types = array('video', 'audio');
            $args->type = 'centralizedresources';
            $centralizedmedia_options = initialise_filepicker($args);
            $centralizedmedia_options->context = $ctx;
            $centralizedmedia_options->client_id = uniqid();
            $centralizedmedia_options->maxbytes  = $this->_options['maxbytes'];
            $centralizedmedia_options->areamaxbytes  = $this->_options['areamaxbytes'];
            $centralizedmedia_options->env = 'editor';
            $centralizedmedia_options->itemid = $draftitemid;

            $fpoptions['image'] = $image_options;
            $fpoptions['media'] = $media_options;
            $fpoptions['link'] = $link_options;
            $fpoptions['subtitle'] = $subtitle_options;
            $fpoptions['centralizedmedia'] = $centralizedmedia_options; // TCS 2019 JBL
        }
