...
class context_block extends context {
    ...
    public function get_context_name($withprefix = true, $short = false) {
        ...
        if ($blockinstance = $DB->get_record('block_instances', array('id'=>$this->_instanceid))) {
            /*ARO BEGIN 3616 12/03/2020 Ajout du IF pour bloquer les blocs obseletes */
            if($blockinstance->blockname != "flexpagenav" && $blockinstance->blockname != "gaia" && $blockinstance->blockname != "flexpagemod" ){
                global $CFG;
