    ...
    _setImage: function(e) {
        ...
        if (url !== '') {
            ...
            if (constrain) {
              ...
              //TCS BEGIN 2015/06/10 - NNE
                //Special case for the centralized resources link
                if(url.indexOf("[[[cr_") === -1){
                ...
                //TCS END 2015/06/10 - NNE
            }

            if(url.indexOf("[[[cr_") === 0){
              template = Y.Handlebars.compile(IMAGETEMPLATE_CR);
            }else{
              template = Y.Handlebars.compile(IMAGETEMPLATE);
            }
