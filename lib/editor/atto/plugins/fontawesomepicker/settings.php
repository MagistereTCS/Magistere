...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new editor_tinymce_json_setting_textarea_fontawesome('atto_fontawesomepicker/availableicons',
        get_string('availableicons', 'atto_fontawesomepicker'), '', '', PARAM_RAW, 100, 8));
