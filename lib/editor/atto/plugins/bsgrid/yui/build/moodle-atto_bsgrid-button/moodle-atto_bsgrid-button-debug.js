...
var col1x3_template =
    '<div class="atto_bsgrid container-fluid">' +
        '<div class="row row-fluid">' +
            '<div class="col-md-3 span4"><p>'+M.util.get_string('column1', 'atto_bsgrid')+'</p></div>' +
            '<div class="col-md-9 span8"><p>'+M.util.get_string('column2', 'atto_bsgrid')+'</p></div>' +
        '</div>' +
    '</div>';
...
var col3x1_template =
    '<div class="atto_bsgrid container-fluid">' +
        '<div class="row row-fluid">' +
            '<div class="col-md-9 span9"><p>'+M.util.get_string('column1', 'atto_bsgrid')+'</p></div>' +
