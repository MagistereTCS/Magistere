                ...
                case 'core_filepicker':
                    $module = array('name'     => 'core_filepicker',
                                    ...
                                    'strings'  => array(array('lastmodified', 'moodle'), array('name', 'moodle'), array('type', 'repository'), array('size', 'repository'),
                                                        ...
                                                        array('referencesexist', 'repository'), array('select', 'repository'), array('domain', 'repository'),
                                                        array('creator', 'repository'), array('lasteditdate', 'repository'),
                                                        array('nofilesavailable_centralized', 'repository')
                                                    ));
                    break;
                case 'core_comment':
