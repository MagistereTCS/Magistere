...
/// Actions ====================================================================
    ...
    public function load_blocks($includeinvisible = null) {
        ...
        // ==============================================================
        // =====3385: [Marque blanche] Le format thématique ARO==========
        // ==============================================================
        ...
        if ($this->page->course->format == 'topics')
        {
	        ...
	        if ($sectionid !== null && $sectionid > 0)
	        {
	        	...
	        	if ($section !== false)
	        	{
	        		$sectionwhere = "AND (bi.sectionid = '".$section->id."' OR bi.sectionid = 0 OR bi.sectionid IS NULL)";
	        	}else{
	        		$sectionwhere = "AND (bi.sectionid = '0' OR bi.sectionid IS NULL)";
	        	}
	        }
        }
...
/// Process actions from the URL ===============================================
    ...
    public function edit_controls($block) {
        ...
        if ($this->page->user_can_edit_blocks() || $block->user_can_edit()) {
            //TCS BEGIN 2020/03/17 - ARO/VSE 3780
            if(isset($block->blockname) && $block->blockname == "block_settings"){
    ...
    public function process_url_edit() {
        ...
        if ($mform->is_cancelled()) {
			...
			$bi->sectionid = isset($data->bui_sectionid) ? $data->bui_sectionid : null;
