...
if ($testsession) {
    if ($testsession == $USER->id) {
    	//TCS BEGIN 2015/11/23 - NNE : cas ou le deeplink est present pour les connexions manuelles
    	if(($deeplink = mmcached_get('mmid_session_'.get_mmid().'_hub_redirection')) !== false){
    		if (strpos($deeplink, $CFG->wwwroot.'/') === 0)
    		{
...
if (isset($SESSION->has_timed_out) && !empty($SESSION->has_timed_out)) {
