...
class mod_hvp_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        if (isset($displayoptions[\H5PCore::DISPLAY_OPTION_FRAME])) {
            ...
            $options = array(\H5PCore::DISPLAY_OPTION_DISPLAYMOD_DEFAULT=>get_string('displaymod_default', 'hvp'),\H5PCore::DISPLAY_OPTION_DISPLAYMOD_INTEGRATED=>get_string('displaymod_integrated', 'hvp'));
            
            $mform->addElement('select', \H5PCore::DISPLAY_OPTION_DISPLAYMOD, get_string('displaymod', 'hvp'), $options);
            $mform->setDefault(\H5PCore::DISPLAY_OPTION_DISPLAYMOD, \H5PCore::DISPLAY_OPTION_DISPLAYMOD_DEFAULT);
            $mform->addHelpButton(\H5PCore::DISPLAY_OPTION_DISPLAYMOD, 'displaymod', 'hvp');
