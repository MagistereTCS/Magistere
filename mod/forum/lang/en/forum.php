...
$string['bynameondate_topic'] = '{$a->name} - {$a->date}';
...
$string['completionpopularity'] = 'Le participant doit obtenir des votes à une discussion :';
$string['completionpopularitygroup'] = 'Votes requis';
$string['completionpopularityhelp'] = 'Votes requis';
...
$string['subject_section_header'] = 'Subjects';
$string['showreplies'] = 'See comments ({$a})';
$string['topicspreviouslink'] =  'Previous page';
$string['topicsnextlink'] =  'Next page';

$string['moretopiceachuser'] = 'More discussion';
$string['moretopicqanda'] = 'More questions';
$string['moretopicblog'] = 'More discussion';
$string['moretopicgeneral'] = 'More discussion';
$string['replyblogfirstpost'] = 'Contribuate'; 
$string['replyblog'] = 'Answer to {$a}';
