...
$cmurl = new moodle_url('/mod/forum/view.php',array('id'=>$cm->id));

$node = $PAGE->navigation->find_active_node();

$courseurl = $node->action;
$i = 0;
...
echo '<div class="mlinks clearfix"><div class="mlink_backtocourse"><a href="'.$courseurl.'"><img src="'.$OUTPUT->image_url('b/backtocourse','forum').'"> Retour au parcours</a></div><div class="mlink_seeother"><a href="'.$cmurl.'"><img src="'.$OUTPUT->image_url('d/discussion','forum').'"> Voir les autres discussions</a></div></div>';
echo '</div>';
...
echo html_writer::script(javascript_for_popularity_buttons(), null);
