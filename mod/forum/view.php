...
/// Print settings and things across the top
    ...
    // 03/08/2017-TCS-NNE START
    $istopicformat = (strpos($PAGE->bodyclasses, 'format-topics') !== false);
    // 03/08/2017-TCS-NNE END
    ...
    switch ($forum->type) {
        ...
        case 'eachuser':
            ...
            if($istopicformat ){
                if (!empty($showall)) {
                    forum_section_print_latest_discussions($course, $forum, 0, 'header', '', -1, -1, -1, 0, $cm);
                } else {
                    forum_section_print_latest_discussions($course, $forum, -1, 'header', '', -1, -1, $page, $CFG->forum_manydiscussions, $cm);
                }
            }
            // 03/08/2017-TCS-NNE END
            else {
