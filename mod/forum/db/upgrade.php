...
function xmldb_forum_upgrade($oldversion) {
    ...
    if ($oldversion < 2016090101) { // magistere
        // Define table forum_popularities to be created.
        $table = new xmldb_table('forum_popularities');
        
        // Adding fields to table forum_popularities.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('post', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0');
        
        // Adding keys to table forum_popularities.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('userid', XMLDB_KEY_FOREIGN, array('userid'), 'user', array('id'));
        $table->add_key('post', XMLDB_KEY_FOREIGN, array('post'), 'forum_posts', array('id'));
        
        // Conditionally launch create table for forum_popularities.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
        
        // Forum savepoint reached.
        upgrade_mod_savepoint(true, 2016090101, 'forum');
    }
    
    if ($oldversion < 2016090102) { // magistere
        // Define table forum_favorities to be created.
        $table = new xmldb_table('forum_favorites');
        
        // Adding fields to table forum_favorites.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('post', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0');
        
        // Adding keys to table forum_favorites.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('userid', XMLDB_KEY_FOREIGN, array('userid'), 'user', array('id'));
        $table->add_key('post', XMLDB_KEY_FOREIGN, array('post'), 'forum_posts', array('id'));
        
        // Conditionally launch create table for forum_favorites.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
        
        // Forum savepoint reached.
        upgrade_mod_savepoint(true, 2016090102, 'forum');
    }
    
    
    
    if ($oldversion < 2016090103) { // magistere
        
        // Add support for pinned discussions.
        $table = new xmldb_table('forum');
        $field = new xmldb_field('completionpopularity', XMLDB_TYPE_INTEGER, '9', null, XMLDB_NOTNULL, null, '0', 'completionposts');
        ...
        // Forum savepoint reached.
        upgrade_mod_savepoint(true, 2016090103, 'forum');
    }
