...
/**
 * Provides the steps to perform one complete backup of the socialforum instance
 */
class backup_socialforum_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_socialforum_activity_structure_step('socialforum_structure', 'socialforum.xml'));
    }
    ...
    static public function encode_content_links($content) {
        ...
        return preg_replace($search, '$@SOCIALFORUMVIEWBYID*$2@$', $content);
    }
}
