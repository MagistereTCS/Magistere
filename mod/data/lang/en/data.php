...
$string['enterroles'] = 'User types selection...';
...
$string['notifcontenthtml'] = '<p>A user sent you a new feedback on your record <br />from the database activity "{$a->bdd}" <br />in the course "{$a->course}".</p>';
$string['notifcontenttxt'] = 'A user sent you a new feedback on your record from the database activity "{$a->bdd}" in the course "{$a->course}".';
$string['notifcontenthtmlrec'] = '<p>A user created a new record in the database activity <br />"{$a->bdd}" in the course "{$a->course}".</p>';
$string['notifcontenttxtrec'] = 'A user created a new record in the database activity "{$a->bdd}" in the course "{$a->course}".';
$string['notiffeedback'] = 'When a feedback is submitted on a form, send a notification to the creator of this form.';
$string['notifications'] = 'Notifications';
$string['notifrecord'] = 'When a form is created, send a notification to these users:';
$string['notifsubject'] = 'New feedback on your record.';
$string['notifsubjectrec'] = 'New record on database.';
...
$string['norolesselectednotification'] = 'Please select at least one role';
