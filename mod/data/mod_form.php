...
class mod_data_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        // CLEO - #1672 - evol 2.0.10 - 26/03/2018
        $this->add_notifications_management();
        //////////////////////////////////////////
...
//-------------------------------------------------------------------------------
    ...
    public function validation($data, $files) {
        ...
        // check if roles has been set
        if($data['notifrecord'] && !isset($data['roles'])){
            $errors['roles'] = get_string('norolesselectednotification', 'mod_data');
        }
