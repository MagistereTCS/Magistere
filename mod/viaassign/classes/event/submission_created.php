...
/**
 * The mod_viaassign submission_created abstract event.
 *
...
/**
 * The mod_viaassign submission_created abstract event class.
 *
...
class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_viaassign');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a virtual classroom with id '$this->objectid' " .
    ...
    protected function validate_data() {
        ...
        if (empty($this->objectid) || empty($this->objecttable)) {
            throw new \coding_exception('The submission_created event must define objectid and object table.');
        }
    }
}