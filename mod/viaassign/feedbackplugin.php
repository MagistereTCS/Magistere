...
require_once($CFG->dirroot.'/mod/viaassign/viaassignmentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from viaassign_plugin abstract class.
 *
 * @package   mod_viaassign
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class viaassign_feedback_plugin extends viaassign_plugin {
...
//     */
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole viaassignment.
     * @return array - An array of action and description strings.
