...
/**
 * Strings for component 'viaassignfeedback_comments', language 'en'
 *
...
$string['default_help'] = 'If set, this feedback method will be enabled by default for all new viaassignments.';
...
$string['commentinlinedefault_help'] = 'If set, this comment inline functionality will be enabled by default for all new viaassignments.';
