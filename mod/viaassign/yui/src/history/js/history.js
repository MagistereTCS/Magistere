// Define a function that will run in the context of a Node instance.

var CSS = {
    LINK: 'mod-viaassign-history-link',
    OPEN: 'mod-viaassign-history-link-open',
    CLOSED: 'mod-viaassign-history-link-closed',
    PANEL: 'mod-viaassign-history-panel'
},
COUNT = 0,
TOGGLE = function() {
    var id = this.get('for'),
