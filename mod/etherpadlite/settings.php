...
$settings->add(new admin_setting_configtext('etherpadlite/urlapi', get_string('urlapi', 'etherpadlite'),
				   get_string('urlapidesc', 'etherpadlite'), 'https://myserver.mydomain.local/moodle/', PARAM_RAW,40));
