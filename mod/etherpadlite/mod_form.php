...
class mod_etherpadlite_mod_form extends moodleform_mod {
    ...
    public function add_completion_rules() {
        ...
        $mform->addElement('checkbox', 'participationisrequired', get_string('participationisrequired', 'mod_etherpadlite'),
            get_string('studenthasparticipated', 'mod_etherpadlite'));

        // $mform->disabledIf('participationisrequired', 'completion', 'ne', COMPLETION_TRACKING_AUTOMATIC);

        return array('participationisrequired');
    }

    function completion_rule_enabled($data) {
        return $data['participationisrequired'];
    }
}
