...
if (!empty($issues)) {
    ...
    foreach ($issues as $issue) {
        ...
        // $actions .= "&nbsp;<a href=\"view.php?id={$cm->id}&amp;view=profile&amp;screen=mywatches&amp;issueid={$issue->id}&what=register\" title=\"".get_string('register', 'tracker')."\" ><img src=\"".$OUTPUT->image_url('register', 'mod_tracker')."\" border=\"0\" /></a>";
