...
class data_deletion_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        //BEGIN ARO 17/04/2020 #3375
        //Permet de limiter l'accès à la vue de suppression aux contextes utilisateurs
        $data->magisterelimitation = $this->filter == 30;
        //END ARO 17/04/2020 #3375 */
