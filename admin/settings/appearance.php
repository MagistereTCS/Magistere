...
preferences,moodle|/user/preferences.php|preferences',
    ...
    //12/07/2017-TCS-VSE BEGIN
    $temp = new admin_externalpage('mypageformer', new lang_string('mypageformer', 'admin'), $CFG->wwwroot . '/my/formersys.php',
    		'moodle/my:configsyspages');
    $ADMIN->add('appearance', $temp);
    
    $temp = new admin_externalpage('mypageseformer', new lang_string('mypageseformer', 'admin'), $CFG->wwwroot . '/my/seformersys.php',
    		'moodle/my:configsyspages');
    $ADMIN->add('appearance', $temp);
    
    $temp = new admin_externalpage('mypageconcevoir', new lang_string('mypageconcevoir', 'admin'), $CFG->wwwroot . '/my/concevoirsys.php',
    		'moodle/my:configsyspages');
    $ADMIN->add('appearance', $temp);
    
    $temp = new admin_externalpage('mypageespacescollaboratifs', new lang_string('mypageespacescollaboratifs', 'admin'), $CFG->wwwroot . '/my/espacescollaboratifssys.php',
    		'moodle/my:configsyspages');
    $ADMIN->add('appearance', $temp);
    //12/07/2017-TCS-VSE END
