...
if($action == "list")
{
    ...
    //{
    	...
    	$result2 = get_aca_stats_per_academy($userrole, $parcoursidentifiant_year, $gaia_origine, $parcoursidentifiant_name, $lastconnmin, $lastconnmax,$select_no_pub,$select_off,$select_offlocales,$select_ofp);
    	/*
    	foreach($academies as $academy=>$daca)
    	{
    		...
    		$r = get_aca_stats_per_academy($userrole) //, $lastconnmax);
    ...
    $jTableResult['TotalRecordCount'] = ($result == false ? 0 : count($result));
