...
class view_statsparticipants_form extends moodleform {
    protected $course;
    protected $context;
...
$(function(){
        	...
        	{
        		downloading = true;
        		$("#mform1").attr("action","view_statsparticipants_export.php?action=export&format=csv&so="+sortorder);
        	...
        	function loadExport(execafter)
        	{
				...
				$.ajax({
					url: "view_statsparticipants_export.php?action=export&format=htmltsv&so=" + sortorder,
					type: "POST",
					data: postData,
				...
				actions: {
                    listAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            ...
                            $.ajax({
                                url: " view_statsparticipants_ajax.php?action=list&so=" + jtParams.jtSorting,
                                type: "POST",
                                dataType: "json",
                                data: postData,
                                success: function (data) {
