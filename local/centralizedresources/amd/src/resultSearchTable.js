define(['local_magisterelib/jtable'], function(){

    function init(url_search, url_getpagerecord, show_checkboxes, show_action,
        show_add_resource_button, show_return_button, add_resource_url, return_url,
        local_cr_jtable_title, local_cr_return_button_label, local_cr_add_resource_button_label, RESOURCELIB_DISPLAY_DOWNLOAD,
        CONTEXT_ID)
    {
        ...
        console.log(local_cr_jtable_title);
    ...
    return {
        init: function(url_search, url_getpagerecord, show_checkboxes, show_action,
                       show_add_resource_button, show_return_button, add_resource_url, return_url,
                       local_cr_jtable_title, local_cr_return_button_label, local_cr_add_resource_button_label, RESOURCELIB_DISPLAY_DOWNLOAD,
                       CONTEXT_ID)
        {
            init(url_search, url_getpagerecord, show_checkboxes, show_action,
                show_add_resource_button, show_return_button, add_resource_url, return_url,
                local_cr_jtable_title, local_cr_return_button_label, local_cr_add_resource_button_label, RESOURCELIB_DISPLAY_DOWNLOAD,
                CONTEXT_ID);
        }
