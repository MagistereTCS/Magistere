    ...
    return {
        init: function(api_url,dispositif_text,module_text,session_text){
            ...
            function loadGroups(groups) {
                ...
                $("#groups select").append("<option value='nogroup' style='font-weight:bold'><b>Aucun groupe</b></options>");
            ...
            function loadGroupings(groupings) {
                ...
                $("#groups select").append("<option value='auto_grouping'>Automatique</options>");
