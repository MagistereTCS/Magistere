...
$string['lasteditdate'] = 'Last edit date';
$string['nofilesavailable_centralized'] = 'Spécifiez des paramètres de recherche (créateur, domaine, date ou mots-clés) pour afficher la liste des ressources correspondantes.';
