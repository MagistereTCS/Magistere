...
$string['completionicons_ma_begin'] = 'Pour vous permettre de suivre votre avancement dans cette formation, des repères de progression ont été mis en place dans cette page.';
$string['completionicons_ma_end'] = 'Un indicateur sous la forme d\'une "coche" s\'affichera dans le sommaire pour vous indiquer que toutes les activités ont bien été réalisées dans cette page.';
$string['completionicons_bds'] = 'La barre de suivi se mettra à jour dès que vous achevez une activité ou que vous cochez un marqueur d\'achèvement.';
$string['completionicons_ma'] = 'Dès que vous estimez avoir terminé cette étape, vous pouvez cocher le ou les marqueur(s) d\'achèvement présent(s) dans cette page.';
$string['completionicons_aa'] = 'Les activités suivantes sont concernées :';
