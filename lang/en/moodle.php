...
$string['addnewview'] = 'Add a new custom view';
...
$string['adduseraca'] = 'To add all the courses from my academy';
$string['admin'] = 'Admin';
...
$string['allcoursesinview'] = 'All courses';
$string['allfilteredcourses'] = 'All filtered ({$a->count}/{$a->total})';
$string['allselectedcourses'] = 'All selected ({$a->count}/{$a->total})';
...
$string['copylink'] = 'Copying in clipboard.';
...
$string['createcustomview'] = 'Create custom view';
...
$string['customviewname'] = 'View name';
$string['customviewcalculation'] = 'To calculate the trainee hours/days';
$string['customviewreport'] = 'To send an automatic report by email';
$string['customviewdisplay'] = 'Display choice';
$string['customviewemails'] = 'Email addresses list (comma to separate)';
$string['customviewfrequency'] = 'Report frequency';
$string['customviewday'] = 'Results sent on';
...
$string['editcustomview'] = 'Edit the custom view settings';
$string['editsettings'] = 'Edit settings';
$string['centralizedresources'] = 'Centralized resources managment';
...
$string['errorviewbadmail'] = 'Email address(es) not valid.';
$string['errorviewnocourse'] = 'Please select some courses.';
$string['errorviewnomail'] = 'Please enter one email address at least.';
...
$string['firstname_help'] = 'POURQUOI MON NOM ET MON PRENOM NE SONT PAS MODIFIABLES ?

Lors de votre connexion à m@gistère, votre nom, prénom et adresse mél professionnelle sont transmis par l\'annuaire de votre académie ou de votre institution. Ces données sont utilisées pour alimenter votre profil sur m@gistère. Elles garantissent à chacun de pouvoir connaître nominativement la liste des personnes avec qui il se forme.
		
MON NOM ET PRENOM NE SONT PAS CORRECTS, COMMENT FAIRE POUR LES CORRIGER ?
		
Il est nécessaire de contacter le service en charge de l\'annuaire de votre académie ou de votre institution de rattachement';
...
$string['lastname_help'] = 'POURQUOI MON NOM ET MON PRENOM NE SONT PAS MODIFIABLES ?
...
$string['modcustomview'] = 'Modifier la vue personnalisée';
...
$string['noselectedcourses'] = 'No course selected';
$string['nofilteredcourses'] = 'No course found';
...
$string['notavailablecourse2'] = 'You cannot access the "{$a}" section.';
...
$string['view'] = 'View';
$string['viewcoursesavailable'] = 'Disponible(s)';
$string['viewcoursesselected'] = 'Sélectionné(s)';
