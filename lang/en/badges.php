...
// TCS custom traduction
$string['tcs_mybadges'] = 'My badges';
$string['jtheader_name'] = 'Name';
$string['jtheader_description'] = 'Description';
$string['jtheader_dateobtained'] = 'Date obtained';
$string['jtheader_visibility'] = 'Visibility';
$string['jtheader_actions'] = 'Enhance the badge';
$string['delete_title'] = 'Delete the badge';
$string['download_title'] = 'Download the badge';
$string['origin'] = 'Domain';
$string['print_title'] = 'Print the badge';
$string['private_state'] = 'Private badge';
$string['private_state_title'] = 'Make the badge private';
$string['public_state'] = 'Public badge';
$string['public_state_title'] = 'Make the badge public';