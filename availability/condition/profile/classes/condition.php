...
class condition extends \core_availability\condition {
    ...
    public static function get_custom_profile_fields() {
        ...
        $allowed_fields = array('rne_etablissement','rne_responsable','departement','circonscription','contrat','type','degre','fonction');
        ...
        if (self::$customprofilefields === null) {
            ...
            foreach ($fields as $field) {
            	if (in_array($field->shortname,$allowed_fields))
            	{
