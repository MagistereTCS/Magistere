...
class core_blog_renderer extends plugin_renderer_base {
    ...
    public function render_blog_entry(blog_entry $entry) {
        ...
        $titlelink = html_writer::link(new moodle_url('/blog/index.php', $params), format_string($entry->subject));
        ...
        $entryurl = new moodle_url('/blog/index.php', $params);
        ...
        if ($entry->renderable->usercanedit) {
            ...
            if (empty($entry->uniquehash)) {
                $params['action'] = 'edit';
                $o .= html_writer::link(new moodle_url('/blog/edit.php', $params), $stredit) . ' | ';
            }
            $params['action'] = 'delete';
            $o .= html_writer::link(new moodle_url('/blog/edit.php', $params), $strdelete) . ' | ';
        }
