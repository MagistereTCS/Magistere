...
$section = optional_param('section', null, PARAM_INT); // To associate the entry with a course.
...
$PAGE->set_url('/blog/edit.php', $params);
...
if ($action === 'delete') {
    ...
    if (data_submitted() && $confirm && confirm_sesskey()) {
        ...
        $heading = $OUTPUT->heading($strblogs . ': ' . get_string('deleteentry', 'blog'), 2);
...
//    echo $OUTPUT->heading($editmodetitle, 2);
    //TCS BEGIN 2015/11/16 - NNE
    $heading = $OUTPUT->heading($editmodetitle, 2);
    echo $OUTPUT->add_encart_activity($heading);
    //TCS BEGIN 2015/11/16 - NNE
}
