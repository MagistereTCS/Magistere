...
class core_course_renderer extends plugin_renderer_base {
    ...
    function course_section_add_cm_control($course, $section, $sectionreturn = null, $displayoptions = array()) {
        ...
        if (course_ajax_enabled($course) && $course->id == $this->page->course->id) {
            ...
            /*#2445 - 22/08/2018 - TCS - no more choice
            ...
            $output = html_writer::tag('div', $output, array('class' => 'hide addresourcedropdown'));
            $modchooser = html_writer::tag('div', $modchooser, array('class' => 'show addresourcemodchooser'));
    ...
    function course_search_form($value = '', $format = 'plain') {
        ...
        $output .= html_writer::start_tag('div', array('class' => 'coursesearchbox'));
        $output .= html_writer::tag('label', $strsearchcourses.': ', array('for' => $inputid));
        $output .= html_writer::empty_tag('input', array('type' => 'text', 'id' => $inputid, 'size' => $inputsize, 'name' => 'search', 'value' => s($value), 'class' => ''));
