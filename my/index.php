...
require_once($CFG->dirroot . '/local/myindex/locallib.php');
...
if (empty($CFG->forcedefaultmymoodle) && $PAGE->user_allowed_editing()) {
    ...
    if (!$currentpage->userid) {
        ...
        $class = "updateoff";
        $resetbutton = new local_myindex_button($reseturl, $resetstring, 'post',  'singlebutton reset');
        $resetbutton = $OUTPUT->render_local_myindex_button($resetbutton);
    }

    $url = new moodle_url("$CFG->wwwroot/my/index.php", $params);
    $button = new local_myindex_button($url, $editstring, 'post',  'singlebutton '.$class);
    $button = $OUTPUT->render_local_myindex_button($button);
