...
$record = $CDB->get_record('cr_avatars', array('id'=>$user->picture));
if ($record !== false) {
    $avatarurl = secure_url('/avatar/f.png', $record->hashname, 3600);
    echo '<img src="'.$avatarurl.'" style="margin-right:20px">';
}
echo '<span style="font-weight:bold;font-size:25px;">'.$user->firstname.' '.$user->lastname.'</span>';
