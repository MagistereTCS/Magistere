...
class core_user_renderer extends plugin_renderer_base {
    ...
    public function user_list($userlist, $exclusivemode) {
        ...
        foreach ($userlist as $user) {
            ...
            if (user_can_view_profile($user)) {
            	...
            	if ($from != null)
            	{
            		...
            		if ($course_ctx !== false)
            		{
            			$params['course'] = $course_ctx->instanceid;
            		}
            	}
            	
            	$profilelink = new moodle_url('/user/view.php', $params);
        ...
        if ($exclusivemode) {
            $output = '<div><ul class="inline-list" style ="margin-left: 10px; margin-top: 25px">';
