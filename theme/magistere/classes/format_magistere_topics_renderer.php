...
require_once($CFG->dirroot.'/course/format/magistere_topics/renderer.php');
class theme_magistere_format_magistere_topics_renderer extends format_magistere_topics_renderer {
